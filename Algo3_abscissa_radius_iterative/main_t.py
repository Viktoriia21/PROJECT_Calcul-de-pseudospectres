...
from algorithm import trace_boundary
...
if __name__ == '__main__':
    ...
    for n in [10, 20]:
        ...
        # sequential tracing
        for idx, z0 in enumerate(z_starts, 1):
            #print(f"tracing from starting point {idx}/{len(z_starts)}...")
            contour = trace_boundary(A, eps, z0, eigvals)
